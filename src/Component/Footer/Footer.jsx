...
const Footer = () => {
   return (
      <div>
         <div className="mt-36 bg-heading">
            <footer className="footer p-10 max-w-7xl mx-auto  text-white ">
               <aside>
                  ...
                  <p>Health Care Industries Ltd.<br />Providing reliable service since 1992</p>
               </aside>
               <nav>
                  <header className="footer-title opacity-100">Services</header>
                  <a className="link link-hover">Pediatric Care</a>
                  <a className="link link-hover">Nutritional Counseling</a>
                  <a className="link link-hover">Home Health Care</a>
                  <a className="link link-hover">Rehabilitation Services</a>
               </nav>
               <nav>
